#ifndef RICHTEXTNOTECSS_H
#define RICHTEXTNOTECSS_H

// CSS for checkbox flicked from:
// http://37signals.com/svn/posts/2609-customizing-web-forms-with-css3-and-webkit

#define RICH_TEXT_NOTE_CSS \
    "<style type=\"text/css\">" \
    "input.en_todo_checkbox {" \
    ...
    "}" \
    "input.en_todo_checkbox:checked {" \
